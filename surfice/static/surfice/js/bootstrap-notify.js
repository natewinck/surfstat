...
(function ($) {
  ...
  Notification.prototype.show = function () {
  	//console.log(typeof this.options.onClose === 'function');
  	if (typeof this.options.onClose === 'function') {
  		n = this;
  		this.$note.delay(this.options.fadeOut.delay || 3000).queue(function(obj) {
  			//console.log(obj);
  			//console.log(this);
  			n.options.onClose(this);
  			//$(n.$note).remove();
  			n.options.onClosed();
  		});
  		
  	} else if (this.options.fadeOut.enabled) {
